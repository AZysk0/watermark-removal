...
# simple_resnet_wm_removal.train(epochs=1)
...
test_wm_image_path = wm_paths[0]
test_clean_image_path = clean_paths[0]
...
cv2.imwrite('output_restored_image.png', cv2.cvtColor(out_image, cv2.COLOR_RGB2BGR))
